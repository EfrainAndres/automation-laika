Feature: Inicio de Sesión en Laika
  ...
  Scenario: Login con credenciales correctas
    When el usuario ingresa su correo "efrainvergara.udec@gmail.com" en el campo de Correo
    ...
    And el usuario verifica que su nombre aparezca "Efrain" en el apartado del perfil
